...
<%
    ...
    if ((contentType.indexOf("multipart/form-data") >= 0)) {
        ...
        factory.setRepository(new File("D:\\PocketDesk\\web\\images\\temp"));
        ...
        try {
            ...
            Connection con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/pocketdesk", "root", "");
